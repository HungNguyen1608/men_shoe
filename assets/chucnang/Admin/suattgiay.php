...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE giay SET Tengiay=?, Maloaigiay=?, Soluong=?, Dongia=?, Mau=?, Hanggiay=?, Thongtin=?, Size=?, Ngaynhap=?, Hinh=?, Giamgia=?, Mancc=? WHERE Magiay=?";
    ...
    $stmt->bind_param("sssssssssssss", $tengiay, $maloaigiay, $soluong, $dongia, $mau, $hanggiay, $thongtin, $size, $ngaynhap, $hinh, $giamgia, $mancc, $magiay);
