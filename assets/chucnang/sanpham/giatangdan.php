<div class="home-product">
    <div class="hienthi__ngang">
        <?php
            ...
            $sql = "SELECT * FROM giay WHERE Tengiay LIKE '%$searchTerm%' ORDER BY Dongia ASC LIMIT $startRow, $rowsPerPage";
            $query = mysqli_query($conn, $sql);
    ...
    <div style="display: flex;align-items: center;">
        ...
        <ul style="display: flex;list-style-type: none;">
            <?php if ($page > 1): ?>
                <li>
                    <a href="?page_layout=tangdan&page=<?php echo ($page - 1); ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>&mataikhoan=<?php echo $mataikhoan; ?>" class="home-filter__page-btn">
            ...
            <?php for ($i=1; $i<=$totalPages; $i++): ?>
                <li>
                    <a href="?page_layout=tangdan&page=<?php echo $i; ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>&mataikhoan=<?php echo $mataikhoan; ?>" class="home-filter__page-btn <?php if ($i==$page) echo 'active'; ?>">
                        <?php echo $i; ?>
                    </a>
                </li>
            <?php endfor; ?>
