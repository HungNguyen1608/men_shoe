<div class="home-product">
    ...
    <div style="display: flex;align-items: center;">
        ...
        <ul style="display: flex;list-style-type: none;">
            <?php if ($page > 1): ?>
                <li>
                    <a href="?page_layout=adidas&page=<?php echo ($page - 1); ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>" class="home-filter__page-btn">
            ...
            <?php for ($i=1; $i<=$totalPages; $i++): ?>
                <li>
                    <a href="?page_layout=adidas&page=<?php echo $i; ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>" class="home-filter__page-btn <?php if ($i==$page) echo 'active'; ?>">
                        <?php echo $i; ?>
                    </a>
                </li>
            <?php endfor; ?>
