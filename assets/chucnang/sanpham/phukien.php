<div class="home-product">
    ...
    <span class="home-filter__page-num">
            ...
            <div class="home-filter__page-control">
                <?php if ($page > 1): ?>
                    <a href="?page_layout=phukien&page=<?php echo ($page - 1); ?>&mataikhoan=<?php echo $mataikhoan; ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>" class="home-filter__page-btn">
                ...
                <?php for ($i=1; $i<=$totalPages; $i++): ?>
                    <a href="?page_layout=phukien&page=<?php echo $i; ?>&mataikhoan=<?php echo $mataikhoan; ?><?php echo $searchTerm ? "&search=$searchTerm" : ''; ?>" class="home-filter__page-btn <?php if ($i==$page) echo 'active'; ?>">
                        <?php echo $i; ?>
                    </a>
                <?php endfor; ?>
