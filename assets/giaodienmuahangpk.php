                                     ...
                                     <div class="thongtinsp">
                                         ...
                                         ?>
                                             <div  class="thongtinsp_item" style="">
                                                 <a href="index.php?page_layout=chitietpk&Magiay=<?php echo $row['Magiay'] ?>"><img  width="80" height="144" src="<?php echo $row['hinh'] ?>" /></a>
        ...
        <?php
                            if (isset($_POST["submit"])) {
                                ...
                                if (empty($Pttt)) {
                                    ...
                                    $insertSql = "INSERT INTO muahang (Mataikhoan, Magiay, Soluong, yeucau, Makhach, ptthanhtoan) 
                                                VALUES ('$mataikhoan', '$magiay', '$soluong', '$yeucau', '$makhach', '$Pttt')";
